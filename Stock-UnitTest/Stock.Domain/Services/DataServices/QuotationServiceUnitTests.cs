...
namespace Stock_UnitTest.Stock.Domain.Services
{
    ...
    public class QuotationServiceUnitTests
    {
        ...
        [TestMethod]
        public void GetQuotations_ReturnsProperCollection_IfAssetAndTimeframeAreGiven()
        {
            ...
            dtos.AddRange(new QuotationDto[] { dto1, dto2, dto3, dto4 });
            mockedRepository.Setup(r => r.GetQuotations(It.IsAny<AnalysisDataQueryDefinition>())).Returns(dtos);

            //Act
            IQuotationService service = QuotationService.Instance();
