...
namespace Stock_UnitTest.Helpers
{
    ...
    public class UTFactory
    {
        ...
        public Trendline getDefaultTrendline()
        {
            ...
            ExtremumGroup baseGroup = new ExtremumGroup(baseMaster, null, UTDefaulter.DEFAULT_INITIAL_IS_PEAK);
            ...
            ExtremumGroup secondGroup = new ExtremumGroup(secondMaster, null, UTDefaulter.DEFAULT_INITIAL_IS_PEAK);
