    ...
    public class PriceDtoUnitTests
    {
        ...
        private PriceDto getDefaultPriceDto()
        {
            return new PriceDto()
            {
                ...
                PriceDirection3D = 1,
                PriceGap = 0.05,
                PeakByCloseEvaluation = 0,
                PeakByHighEvaluation = 0,
        ...
        [TestMethod]
        public void Equals_ReturnsFalse_IfPeakByCloseEvaluationIsDifferent()
        {
            ...
            //Act
            comparedItem.PeakByCloseEvaluation += 0.015;
            var areEqual = baseItem.Equals(comparedItem);
        ...
        [TestMethod]
        public void Equals_ReturnsFalse_IfPeakByHighEvaluationIsDifferent()
        {
            ...
            //Act
            comparedItem.PeakByHighEvaluation += 0.015;
            var areEqual = baseItem.Equals(comparedItem);
        ...
        [TestMethod]
        public void Equals_ReturnsFalse_IfTroughByCloseEvaluationIsDifferent()
        {
            ...
            //Act
            comparedItem.TroughByCloseEvaluation += 0.015;
            var areEqual = baseItem.Equals(comparedItem);
        ...
        [TestMethod]
        public void Equals_ReturnsFalse_IfTroughByLowEvaluationIsDifferent()
        {
            ...
            //Act
            comparedItem.TroughByLowEvaluation += 0.015;
            var areEqual = baseItem.Equals(comparedItem);
